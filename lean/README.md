...
| `Dcf` | `examples/dcf.json` vale exatamente `91840/1331`; o valor impresso é o arredondamento correto a 28 dígitos, e o impresso antes da correção errava o último dígito | `calculos.py`, modo `dcf` |
...
- **Arredondamento de `Decimal`.** Os modelos usam racionais exatos. Só a conversão (onde o
  arredondamento altera um resultado discreto) e o valor impresso no exemplo de DCF foram
  comparados com a saída real do script.
